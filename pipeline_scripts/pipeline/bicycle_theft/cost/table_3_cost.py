...
bicycle_cost_table.reset_index(inplace=True)

bicycle_cost_table = bicycle_cost_table.drop(['index'], axis = 1)

##################################################################################
#FILLING IN MISSING DATA
#################################################################################

bicycle_cost_table.fillna(0, inplace = True)

bicycle_cost_table.replace(np.inf, np.nan, inplace = True)

bicycle_cost_table[[
        'Latest year compared with Mar 10',
        'Latest year compared with Mar 19']] = bicycle_cost_table[[
                'Latest year compared with Mar 10',
...
bicycle_cost_table_order = [0,1,4,6,3,5,7,2,8,9,10]

bicycle_cost_table_3 = bicycle_cost_table.reindex(bicycle_cost_table_order)
