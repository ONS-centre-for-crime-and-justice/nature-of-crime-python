...
check = other_personal_theft_offences.groupby(['financial_year','totval2']).sum()

subtable_1_data = other_personal_theft_offences[
        (other_personal_theft_offences['totval2'] < 9)]
...
other_personal_theft_cost_table = pd.concat([
                                subtable_1,
                                subtable_2,
                                subtable_3,
                                subtable_1_base,
...
other_personal_theft_cost_table.reset_index(inplace=True)

other_personal_theft_cost_table = other_personal_theft_cost_table.drop(['index'], axis = 1)

##################################################################################
#FILLING IN MISSING DATA
#################################################################################

other_personal_theft_cost_table.fillna(0, inplace = True)

other_personal_theft_cost_table.replace(np.inf, np.nan, inplace = True)

other_personal_theft_cost_table[[
        'Latest year compared with Mar 10',
        'Latest year compared with Mar 19']] = other_personal_theft_cost_table[[
                'Latest year compared with Mar 10',
...
other_personal_theft_cost_table_order = [0,1,4,6,3,5,7,2,8,9,10]
other_personal_theft_cost_table_4b = other_personal_theft_cost_table.reindex(other_personal_theft_cost_table_order)
