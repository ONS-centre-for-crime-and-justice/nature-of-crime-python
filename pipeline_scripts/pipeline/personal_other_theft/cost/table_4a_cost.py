...
subtable_1_data = personal_theft_offences[
        (personal_theft_offences['totval2'] < 9)]
...
personal_theft_cost_table = pd.concat([
                                subtable_1,
                                subtable_2,
                                subtable_3,
                                subtable_1_base,
...
personal_theft_cost_table.reset_index(inplace=True)

personal_theft_cost_table = personal_theft_cost_table.drop(['index'], axis = 1)

##################################################################################
#FILLING IN MISSING DATA
#################################################################################

personal_theft_cost_table.fillna(0, inplace = True)

personal_theft_cost_table.replace(np.inf, np.nan, inplace = True)

personal_theft_cost_table[[
        'Latest year compared with Mar 10',
        'Latest year compared with Mar 19']] = personal_theft_cost_table[[
                'Latest year compared with Mar 10',
...
personal_theft_cost_table_order = [0,1,4,6,3,5,7,2,8,9,10]
personal_theft_cost_table_4a = personal_theft_cost_table.reindex(personal_theft_cost_table_order)
