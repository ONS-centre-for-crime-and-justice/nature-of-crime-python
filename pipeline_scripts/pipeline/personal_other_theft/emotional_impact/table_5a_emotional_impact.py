...
personal_theft_offences['validoff'] = 0
...
personal_theft_emotional_impact_table_5a = emotional_impact_table.drop(['index'], axis = 1) 

##################################################################################
#ADDING SUBTABLE TITLES
##################################################################################

personal_theft_emotional_impact_table_5a.insert(loc=0, column='table_title', value=['' for i in range(personal_theft_emotional_impact_table_5a.shape[0])])

personal_theft_emotional_impact_table_5a.loc[0, 'table_title'] = 'Extent of impact'

personal_theft_emotional_impact_table_5a.loc[6, 'table_title'] = 'Type of emotional response experienced'
