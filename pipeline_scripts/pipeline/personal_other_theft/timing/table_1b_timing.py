...
other_personal_theft_offences = other_personal_theft_offences[(other_personal_theft_offences['vftype'] == 1)]
        
##################################################################################
#CREATING SUBTABLES
##################################################################################

subtable_1_data = other_personal_theft_offences[(other_personal_theft_offences['when1'] == 1) |
                                           (other_personal_theft_offences['when1'] == 2) ]

subtable_1 = ct.table.percentages_nonbinary(subtable_1_data, 'financial_year', 'when1', 'c11weighti', 'total_c11weighti',lookup_dict)

subtable_data = other_personal_theft_offences[(other_personal_theft_offences['time1'] == 1) |
                                         (other_personal_theft_offences['time1'] == 2) |
                                         (other_personal_theft_offences['time1'] == 3) |
                                         (other_personal_theft_offences['time1'] == 4) |
                                         (other_personal_theft_offences['time1'] == 5) |
                                         (other_personal_theft_offences['time1'] == 6) |
                                         (other_personal_theft_offences['time1'] == 7) ]
...
subtable_5_data = other_personal_theft_offences[(other_personal_theft_offences['daylight'] < 4)]
...
other_personal_theft_timing_table = pd.concat([
        subtable_1,
        subtable_1_base,
        subtable_2,
        subtable_3,
...
other_personal_theft_timing_table.reset_index(inplace = True)

other_personal_theft_timing_table = other_personal_theft_timing_table.drop(['index'], axis = 1)

##################################################################################
#FILLING IN MISSING DATA
#################################################################################

other_personal_theft_timing_table.fillna(0, inplace = True)

other_personal_theft_timing_table.replace(np.inf, np.nan, inplace = True)

other_personal_theft_timing_table[[
        'Latest year compared with Mar 10',
        'Latest year compared with Mar 19']] = other_personal_theft_timing_table[[
                'Latest year compared with Mar 10',
...
other_personal_theft_timing_table_order = [1,0,2,17,7,3,8,16,10,4,6,9,5,18,21,19,20,22]
other_personal_theft_timing_table_1b = other_personal_theft_timing_table.reindex(other_personal_theft_timing_table_order)
