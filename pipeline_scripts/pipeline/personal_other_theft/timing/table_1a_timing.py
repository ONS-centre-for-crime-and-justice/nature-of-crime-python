...
personal_theft_offences = personal_theft_offences[(personal_theft_offences['vftype'] == 1)]

##################################################################################
#CREATING SUBTABLES
##################################################################################

subtable_1_data = personal_theft_offences[(personal_theft_offences['when1'] == 1) |
                                           (personal_theft_offences['when1'] == 2) ]

subtable_1 = ct.table.percentages_nonbinary(subtable_1_data, 'financial_year', 'when1', 'c11weighti', 'total_c11weighti',lookup_dict)

subtable_data = personal_theft_offences[(personal_theft_offences['time1'] == 1) |
                                         (personal_theft_offences['time1'] == 2) |
                                         (personal_theft_offences['time1'] == 3) |
                                         (personal_theft_offences['time1'] == 4) |
                                         (personal_theft_offences['time1'] == 5) |
                                         (personal_theft_offences['time1'] == 6) |
                                         (personal_theft_offences['time1'] == 7) ]
...
subtable_5_data = personal_theft_offences[(personal_theft_offences['daylight'] < 4)]
...
personal_theft_timing_table = pd.concat([
        subtable_1,
        subtable_1_base,
        subtable_2,
        subtable_3,
...
personal_theft_timing_table.reset_index(inplace = True)

personal_theft_timing_table = personal_theft_timing_table.drop(['index'], axis = 1)

##################################################################################
#FILLING IN MISSING DATA
#################################################################################

personal_theft_timing_table.fillna(0, inplace = True)

personal_theft_timing_table.replace(np.inf, np.nan, inplace = True)

personal_theft_timing_table[[
        'Latest year compared with Mar 10',
        'Latest year compared with Mar 19']] = personal_theft_timing_table[[
                'Latest year compared with Mar 10',
...
personal_theft_timing_table_order = [1,0,2,17,7,3,8,16,10,4,6,9,5,18,21,19,20,22]
personal_theft_timing_table_1a = personal_theft_timing_table.reindex(personal_theft_timing_table_order)
