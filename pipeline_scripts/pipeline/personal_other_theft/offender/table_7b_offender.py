...
other_personal_theft_offences =other_personal_theft_offences[(other_personal_theft_offences['seeany'] <3)]

subtable_1_base = other_personal_theft_offences.groupby(['financial_year']).sum()
...
subtable_1 = ct.table.percentages_binary(other_personal_theft_offences,'financial_year', 'seeany','c11weighti', 'total_c11weighti',lookup_dict)
...
correct_offences_numoff = other_personal_theft_offences[
        (other_personal_theft_offences['numoff'] < 5) ]  
...
correct_offences_sex = other_personal_theft_offences[
        (other_personal_theft_offences['ofsex'] < 4) ] 
...
other_personal_theft_offences['filtered_age'] = 0
...
correct_offences_relate = other_personal_theft_offences[(other_personal_theft_offences['seeany'] == 1) &
       ((other_personal_theft_offences['relate'] == 1) |
        (other_personal_theft_offences['relate'] == 2) |
        (other_personal_theft_offences['relate'] == 3)) ]
...
other_personal_theft_offender_table = pd.concat([
        subtable_1,
        subtable_1_base,
        subtable_2,
        subtable_3,
...
other_personal_theft_offender_table.reset_index(inplace = True)

other_personal_theft_offender_table = other_personal_theft_offender_table.drop(['index'],axis =1)

##################################################################################
#FILLING IN MISSING DATA
#################################################################################

other_personal_theft_offender_table.fillna(0, inplace = True)

other_personal_theft_offender_table.replace(np.inf, np.nan, inplace = True)

other_personal_theft_offender_table[[
        'Latest year compared with Mar 10',
        'Latest year compared with Mar 19']] = other_personal_theft_offender_table[[
                'Latest year compared with Mar 10',
...
other_personal_theft_offender_table_order = [0,1,3,5,4,2,8,7,6,14,13,9,10,11,12,15,18,16,17,19]

other_personal_theft_offender_table_7b = other_personal_theft_offender_table.reindex(other_personal_theft_offender_table_order)

other_personal_theft_offender_table_7b.reset_index(inplace = True)

other_personal_theft_offender_table_7b = other_personal_theft_offender_table_7b.drop(['index'], axis = 1) 

##################################################################################
#ADDING SUBTABLE TITLES
##################################################################################

other_personal_theft_offender_table_7b.insert(loc=0, column='table_title', value=['' for i in range(other_personal_theft_offender_table_7b.shape[0])])

other_personal_theft_offender_table_7b.loc[2, 'table_title'] = 'Number of offenders'

other_personal_theft_offender_table_7b.loc[6, 'table_title'] = 'Sex of offender(s)'

other_personal_theft_offender_table_7b.loc[9, 'table_title'] = 'Age of offender(s)'

other_personal_theft_offender_table_7b.loc[16, 'table_title'] = 'Relationship to victim'
