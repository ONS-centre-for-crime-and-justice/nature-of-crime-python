...
subtable_data = vehicle_offences[
        (vehicle_offences['valvehx'] < 9)]

subtable_1 = ct.table.percentages_nonbinary(
               subtable_data, 'financial_year', 'valvehx', 'c11weighti', 'total_c11weighti',lookup_dict)
...
subtable_data['weighted_value'] = (
        (subtable_data['c11weighti'])*(subtable_data['valveh'])
        ) 
...
median_10 = ct.table.median_calculation(data_10,'valveh', 'c11weighti')
median_10 ['financial_year'] = "Apr '09 to Mar '10"

median_11 = ct.table.median_calculation(data_11,'valveh', 'c11weighti')
median_11 ['financial_year'] = "Apr '10 to Mar '11"

median_12 = ct.table.median_calculation(data_12,'valveh', 'c11weighti')
median_12 ['financial_year'] = "Apr '11 to Mar '12"

median_13 = ct.table.median_calculation(data_13,'valveh', 'c11weighti')
median_13 ['financial_year'] = "Apr '12 to Mar '13"

median_14 = ct.table.median_calculation(data_14,'valveh', 'c11weighti')
median_14 ['financial_year'] = "Apr '13 to Mar '14"

median_15 = ct.table.median_calculation(data_15,'valveh', 'c11weighti')
median_15 ['financial_year'] = "Apr '14 to Mar '15"

median_16 = ct.table.median_calculation(data_16,'valveh', 'c11weighti')
median_16 ['financial_year'] = "Apr '15 to Mar '16"

median_17 = ct.table.median_calculation(data_17,'valveh', 'c11weighti')
median_17 ['financial_year'] = "Apr '16 to Mar '17"

median_18 = ct.table.median_calculation(data_18,'valveh', 'c11weighti')
median_18 ['financial_year'] = "Apr '17 to Mar '18"

median_19 = ct.table.median_calculation(data_19,'valveh', 'c11weighti')
median_19 ['financial_year'] = "Apr '18 to Mar '19"

median_20 = ct.table.median_calculation(data_20,'valveh', 'c11weighti')
...
subtable_2['Latest year compared with Mar 10'] = ct.sig_testing.ten_year_sig_test_means(subtable_2, subtable_data, 'valveh', subtable_base)
subtable_2['Latest year compared with Mar 19'] = ct.sig_testing.previous_year_sig_test_means(subtable_2, subtable_data, 'valveh', subtable_base)
...
vehicle_cost_stolen_table_7a = vehicle_cost_table.reindex(vehicle_cost_table_order)
