...
vehicle_emotional_impact_table_8d = pd.concat([
        subtable_1,
        subtable_1_base,
        subtable_2,
        subtable_2_base
        ], axis = 0)
vehicle_emotional_impact_table_8d.reset_index(inplace = True)

vehicle_emotional_impact_table_8d = vehicle_emotional_impact_table_8d.drop(['index'], axis = 1) 

##################################################################################
#ADDING SUBTABLE TITLES
##################################################################################

vehicle_emotional_impact_table_8d.insert(loc=0, column='table_title', value=['' for i in range(vehicle_emotional_impact_table_8d.shape[0])])

vehicle_emotional_impact_table_8d.loc[0, 'table_title'] = 'Extent of impact'

vehicle_emotional_impact_table_8d.loc[6, 'table_title'] = 'Type of emotional response experienced'

##################################################################################
#FILLING IN MISSING DATA
#################################################################################

vehicle_emotional_impact_table_8d.fillna(0, inplace = True)

vehicle_emotional_impact_table_8d.replace(np.inf, np.nan, inplace = True)

vehicle_emotional_impact_table_8d[[
        'Latest year compared with Mar 10',
        'Latest year compared with Mar 19']] = vehicle_emotional_impact_table_8d[[
                'Latest year compared with Mar 10',
