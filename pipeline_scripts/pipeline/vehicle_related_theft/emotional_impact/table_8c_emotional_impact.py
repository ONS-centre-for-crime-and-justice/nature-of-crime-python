...
vehicle_offences = correct_area[
        ((correct_area['offence'] == 61) | (correct_area['offence'] == 63))
        ]
...
vehicle_emotional_impact_table_8c = pd.concat([
        subtable_1,
        subtable_1_base,
        subtable_2,
        subtable_2_base
        ], axis = 0)
vehicle_emotional_impact_table_8c.reset_index(inplace = True)

vehicle_emotional_impact_table_8c = vehicle_emotional_impact_table_8c.drop(['index'], axis = 1) 

##################################################################################
#ADDING SUBTABLE TITLES
##################################################################################

vehicle_emotional_impact_table_8c.insert(loc=0, column='table_title', value=['' for i in range(vehicle_emotional_impact_table_8c.shape[0])])

vehicle_emotional_impact_table_8c.loc[0, 'table_title'] = 'Extent of impact'

vehicle_emotional_impact_table_8c.loc[6, 'table_title'] = 'Type of emotional response experienced'

##################################################################################
#FILLING IN MISSING DATA
#################################################################################

vehicle_emotional_impact_table_8c.fillna(0, inplace = True)

vehicle_emotional_impact_table_8c.replace(np.inf, np.nan, inplace = True)

vehicle_emotional_impact_table_8c[[
        'Latest year compared with Mar 10',
        'Latest year compared with Mar 19']] = vehicle_emotional_impact_table_8c[[
                'Latest year compared with Mar 10',
