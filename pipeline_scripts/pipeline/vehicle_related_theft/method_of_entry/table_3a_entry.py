...
##############################################################################
#SELECTING THE OFFENCES FOR THE TABLE  - all vehicle offences
###############################################################################
...
vehicle_entry_table_3a = vehicle_entry_table.drop(['index'], axis = 1)

##################################################################################
#FILLING IN MISSING DATA
##################################################################################
vehicle_entry_table_3a.fillna(0, inplace = True)

vehicle_entry_table_3a.replace(np.inf, np.nan, inplace = True)

vehicle_entry_table_3a[[
        'Latest year compared with Mar 10',
        'Latest year compared with Mar 19']] = vehicle_entry_table_3a[[
                'Latest year compared with Mar 10',
