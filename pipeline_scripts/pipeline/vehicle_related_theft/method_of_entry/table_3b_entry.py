...
vehicle_entry_table_3b = vehicle_entry_table.drop(['index'], axis = 1)
        
##################################################################################
#FILLING IN MISSING DATA
##################################################################################
vehicle_entry_table_3b.fillna(0, inplace = True)

vehicle_entry_table_3b.replace(np.inf, np.nan, inplace = True)

vehicle_entry_table_3b[[
        'Latest year compared with Mar 10',
        'Latest year compared with Mar 19']] = vehicle_entry_table_3b[[
                'Latest year compared with Mar 10',
