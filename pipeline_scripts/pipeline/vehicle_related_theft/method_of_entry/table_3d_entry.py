...
##############################################################################
#SELECTING THE OFFENCES FOR THE TABLE - attempted vehicle related thefts
###############################################################################
...
subtable_1 = ct.table.percentages_nonbinary(vehicle_offences,'financial_year','htryca3','c11weighti','Total_C11weighti', lookup_dict)
...
vehicle_entry_table_3d = vehicle_entry_table.drop(['index'], axis = 1)

##################################################################################
#FILLING IN MISSING DATA
##################################################################################
vehicle_entry_table_3d.fillna(0, inplace = True)

vehicle_entry_table_3d.replace(np.inf, np.nan, inplace = True)

vehicle_entry_table_3d[[
        'Latest year compared with Mar 10',
        'Latest year compared with Mar 19']] = vehicle_entry_table_3d[[
                'Latest year compared with Mar 10',
