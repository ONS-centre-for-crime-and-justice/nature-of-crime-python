...
vehicle_seriousness_table.reset_index(inplace=True)
vehicle_seriousness_table_9b = vehicle_seriousness_table.drop(['index'], axis = 1)

##################################################################################
#ADDING SUBTABLE TITLES
##################################################################################

vehicle_seriousness_table_9b.insert(loc=0, column='table_title', value=['' for i in range(vehicle_seriousness_table_9b.shape[0])])

vehicle_seriousness_table_9b.loc[0, 'table_title'] = 'Perception of incident'

vehicle_seriousness_table_9b.loc[4, 'table_title'] = 'Rated seriousness of crime'