...
vehicle_seriousness_table.reset_index(inplace=True)
vehicle_seriousness_table_9d = vehicle_seriousness_table.drop(['index'], axis = 1)

##################################################################################
#ADDING SUBTABLE TITLES
##################################################################################

vehicle_seriousness_table_9d.insert(loc=0, column='table_title', value=['' for i in range(vehicle_seriousness_table_9d.shape[0])])

vehicle_seriousness_table_9d.loc[0, 'table_title'] = 'Perception of incident'

vehicle_seriousness_table_9d.loc[4, 'table_title'] = 'Rated seriousness of crime'
