...
vehicle_seriousness_table.reset_index(inplace=True)
vehicle_seriousness_table_9a = vehicle_seriousness_table.drop(['index'], axis = 1)

##################################################################################
#ADDING SUBTABLE TITLES
##################################################################################

vehicle_seriousness_table_9a.insert(loc=0, column='table_title', value=['' for i in range(vehicle_seriousness_table_9a.shape[0])])

vehicle_seriousness_table_9a.loc[0, 'table_title'] = 'Perception of incident'

vehicle_seriousness_table_9a.loc[4, 'table_title'] = 'Rated seriousness of crime'
