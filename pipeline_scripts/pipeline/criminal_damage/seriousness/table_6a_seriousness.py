...
criminal_damage_seriousness_table_6a = criminal_damage_seriousness_table.drop(['index'], axis = 1)

##################################################################################
#ADDING SUBTABLE TITLES
##################################################################################

criminal_damage_seriousness_table_6a.insert(loc=0, column='table_title', value=['' for i in range(criminal_damage_seriousness_table_6a.shape[0])])

criminal_damage_seriousness_table_6a.loc[0, 'table_title'] = 'Perception of incident'

criminal_damage_seriousness_table_6a.loc[4, 'table_title'] = 'Rated seriousness of crime'
