...
criminal_damage_offender_table_7c = criminal_damage_offender_table.reindex(criminal_damage_offender_table_order)

criminal_damage_offender_table_7c.reset_index(inplace = True)

criminal_damage_offender_table_7c = criminal_damage_offender_table_7c.drop(['index'], axis = 1) 

##################################################################################
#ADDING SUBTABLE TITLES
##################################################################################

criminal_damage_offender_table_7c.insert(loc=0, column='table_title', value=['' for i in range(criminal_damage_offender_table_7c.shape[0])])

criminal_damage_offender_table_7c.loc[2, 'table_title'] = 'Number of offenders'

criminal_damage_offender_table_7c.loc[6, 'table_title'] = 'Sex of offender(s)'

criminal_damage_offender_table_7c.loc[9, 'table_title'] = 'Age of offender(s)'

criminal_damage_offender_table_7c.loc[16, 'table_title'] = 'Relationship to victim'
