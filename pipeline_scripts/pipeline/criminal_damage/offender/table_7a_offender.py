...
criminal_damage_offender_table_7a = criminal_damage_offender_table.reindex(criminal_damage_offender_table_order)

criminal_damage_offender_table_7a.reset_index(inplace = True)

criminal_damage_offender_table_7a = criminal_damage_offender_table_7a.drop(['index'], axis = 1) 

##################################################################################
#ADDING SUBTABLE TITLES
##################################################################################

criminal_damage_offender_table_7a.insert(loc=0, column='table_title', value=['' for i in range(criminal_damage_offender_table_7a.shape[0])])

criminal_damage_offender_table_7a.loc[2, 'table_title'] = 'Number of offenders'

criminal_damage_offender_table_7a.loc[6, 'table_title'] = 'Sex of offender(s)'

criminal_damage_offender_table_7a.loc[9, 'table_title'] = 'Age of offender(s)'

criminal_damage_offender_table_7a.loc[16, 'table_title'] = 'Relationship to victim'
