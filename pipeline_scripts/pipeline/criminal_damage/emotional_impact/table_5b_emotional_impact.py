...
criminal_damage_emotional_impact_table_5b = pd.concat([
        subtable_1,
        subtable_1_base,
        subtable_2,
        subtable_2_base
        ], axis = 0)
criminal_damage_emotional_impact_table_5b .reset_index(inplace = True)

##################################################################################
#FILLING IN MISSING DATA
#################################################################################

criminal_damage_emotional_impact_table_5b.fillna(0, inplace = True)

criminal_damage_emotional_impact_table_5b.replace(np.inf, np.nan, inplace = True)

criminal_damage_emotional_impact_table_5b[[
        'Latest year compared with Mar 10',
        'Latest year compared with Mar 19']] = criminal_damage_emotional_impact_table_5b[[
                'Latest year compared with Mar 10',
...
criminal_damage_emotional_impact_table_5b = criminal_damage_emotional_impact_table_5b.drop(['index'], axis = 1) 

##################################################################################
#ADDING SUBTABLE TITLES
##################################################################################

criminal_damage_emotional_impact_table_5b.insert(loc=0, column='table_title', value=['' for i in range(criminal_damage_emotional_impact_table_5b.shape[0])])

criminal_damage_emotional_impact_table_5b.loc[0, 'table_title'] = 'Extent of impact'

criminal_damage_emotional_impact_table_5b.loc[6, 'table_title'] = 'Type of emotional response experienced'
