...
criminal_damage_emotional_impact_table_5a = pd.concat([
        subtable_1,
        subtable_1_base,
        subtable_2,
        subtable_2_base
        ], axis = 0)
criminal_damage_emotional_impact_table_5a .reset_index(inplace = True)

##################################################################################
#FILLING IN MISSING DATA
#################################################################################

criminal_damage_emotional_impact_table_5a.fillna(0, inplace = True)

criminal_damage_emotional_impact_table_5a.replace(np.inf, np.nan, inplace = True)

criminal_damage_emotional_impact_table_5a[[
        'Latest year compared with Mar 10',
        'Latest year compared with Mar 19']] = criminal_damage_emotional_impact_table_5a[[
                'Latest year compared with Mar 10',
...
criminal_damage_emotional_impact_table_5a = criminal_damage_emotional_impact_table_5a.drop(['index'], axis = 1) 

##################################################################################
#ADDING SUBTABLE TITLES
##################################################################################

criminal_damage_emotional_impact_table_5a.insert(loc=0, column='table_title', value=['' for i in range(criminal_damage_emotional_impact_table_5a.shape[0])])

criminal_damage_emotional_impact_table_5a.loc[0, 'table_title'] = 'Extent of impact'

criminal_damage_emotional_impact_table_5a.loc[6, 'table_title'] = 'Type of emotional response experienced'
