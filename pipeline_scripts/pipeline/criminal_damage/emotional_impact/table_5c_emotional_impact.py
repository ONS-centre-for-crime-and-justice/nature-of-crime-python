...
criminal_damage_emotional_impact_table_5c = pd.concat([
        subtable_1,
        subtable_1_base,
        subtable_2,
        subtable_2_base
        ], axis = 0)
criminal_damage_emotional_impact_table_5c .reset_index(inplace = True)

##################################################################################
#FILLING IN MISSING DATA
#################################################################################

criminal_damage_emotional_impact_table_5c.fillna(0, inplace = True)

criminal_damage_emotional_impact_table_5c.replace(np.inf, np.nan, inplace = True)

criminal_damage_emotional_impact_table_5c[[
        'Latest year compared with Mar 10',
        'Latest year compared with Mar 19']] = criminal_damage_emotional_impact_table_5c[[
                'Latest year compared with Mar 10',
...
criminal_damage_emotional_impact_table_5c = criminal_damage_emotional_impact_table_5c.drop(['index'], axis = 1) 

##################################################################################
#ADDING SUBTABLE TITLES
##################################################################################

criminal_damage_emotional_impact_table_5c.insert(loc=0, column='table_title', value=['' for i in range(criminal_damage_emotional_impact_table_5c.shape[0])])

criminal_damage_emotional_impact_table_5c.loc[0, 'table_title'] = 'Extent of impact'

criminal_damage_emotional_impact_table_5c.loc[6, 'table_title'] = 'Type of emotional response experienced'
