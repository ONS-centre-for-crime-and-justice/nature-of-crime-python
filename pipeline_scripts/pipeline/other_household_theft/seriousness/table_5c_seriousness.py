...
household_theft_seriousness_table.reset_index(inplace=True)
household_theft_seriousness_table_5c = household_theft_seriousness_table.drop(['index'], axis = 1)

##################################################################################
#ADDING SUBTABLE TITLES
##################################################################################

household_theft_seriousness_table_5c.insert(loc=0, column='table_title', value=['' for i in range(household_theft_seriousness_table_5c.shape[0])])

household_theft_seriousness_table_5c.loc[0, 'table_title'] = 'Perception of incident'

household_theft_seriousness_table_5c.loc[4, 'table_title'] = 'Rated seriousness of crime'