...
household_theft_emotional_impact_table_4a = pd.concat([
        subtable_1,
        subtable_1_base,
        subtable_2,
        subtable_2_base
        ], axis = 0)
household_theft_emotional_impact_table_4a.reset_index(inplace = True)

##################################################################################
#FILLING IN MISSING DATA
#################################################################################

household_theft_emotional_impact_table_4a.fillna(0, inplace = True)

household_theft_emotional_impact_table_4a.replace(np.inf, np.nan, inplace = True)

household_theft_emotional_impact_table_4a[[
        'Latest year compared with Mar 10',
        'Latest year compared with Mar 19']] = household_theft_emotional_impact_table_4a[[
                'Latest year compared with Mar 10',
                'Latest year compared with Mar 19']].replace ([0], [''])

household_theft_emotional_impact_table_4a = household_theft_emotional_impact_table_4a.drop(['index'], axis = 1)    

##################################################################################
#ADDING SUBTABLE TITLES
##################################################################################

household_theft_emotional_impact_table_4a.insert(loc=0, column='table_title', value=['' for i in range(household_theft_emotional_impact_table_4a.shape[0])])

household_theft_emotional_impact_table_4a.loc[0, 'table_title'] = 'Extent of impact'

household_theft_emotional_impact_table_4a.loc[6, 'table_title'] = 'Type of emotional response experienced'