...
household_theft_emotional_impact_table_4b = pd.concat([
        subtable_1,
        subtable_1_base,
        subtable_2,
        subtable_2_base
        ], axis = 0)
household_theft_emotional_impact_table_4b.reset_index(inplace = True)

##################################################################################
#FILLING IN MISSING DATA
#################################################################################

household_theft_emotional_impact_table_4b.fillna(0, inplace = True)

household_theft_emotional_impact_table_4b.replace(np.inf, np.nan, inplace = True)

household_theft_emotional_impact_table_4b[[
        'Latest year compared with Mar 10',
        'Latest year compared with Mar 19']] = household_theft_emotional_impact_table_4b[[
                'Latest year compared with Mar 10',
                'Latest year compared with Mar 19']].replace ([0], [''])

household_theft_emotional_impact_table_4b = household_theft_emotional_impact_table_4b.drop(['index'], axis = 1)   

##################################################################################
#ADDING SUBTABLE TITLES
##################################################################################

household_theft_emotional_impact_table_4b.insert(loc=0, column='table_title', value=['' for i in range(household_theft_emotional_impact_table_4b.shape[0])])

household_theft_emotional_impact_table_4b.loc[0, 'table_title'] = 'Extent of impact'

household_theft_emotional_impact_table_4b.loc[6, 'table_title'] = 'Type of emotional response experienced'