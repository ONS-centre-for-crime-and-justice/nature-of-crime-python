...
subtable_3_base ['table_label'] = 'Unweighted base'
...
household_theft_offender_table_6c = household_theft_offender_table.reindex(household_theft_offender_table_order)

household_theft_offender_table_6c.reset_index(inplace = True)

household_theft_offender_table_6c = household_theft_offender_table_6c.drop(['index'], axis = 1) 

##################################################################################
#ADDING SUBTABLE TITLES
##################################################################################

household_theft_offender_table_6c.insert(loc=0, column='table_title', value=['' for i in range(household_theft_offender_table_6c.shape[0])])

household_theft_offender_table_6c.loc[2, 'table_title'] = 'Number of offenders'

household_theft_offender_table_6c.loc[6, 'table_title'] = 'Sex of offender(s)'

household_theft_offender_table_6c.loc[9, 'table_title'] = 'Age of offender(s)'

household_theft_offender_table_6c.loc[16, 'table_title'] = 'Relationship to victim'