...
household_theft_offender_table_6b = household_theft_offender_table.reindex(household_theft_offender_table_order)

household_theft_offender_table_6b.reset_index(inplace = True)

household_theft_offender_table_6b = household_theft_offender_table_6b.drop(['index'], axis = 1) 

##################################################################################
#ADDING SUBTABLE TITLES
##################################################################################

household_theft_offender_table_6b.insert(loc=0, column='table_title', value=['' for i in range(household_theft_offender_table_6b.shape[0])])

household_theft_offender_table_6b.loc[2, 'table_title'] = 'Number of offenders'

household_theft_offender_table_6b.loc[6, 'table_title'] = 'Sex of offender(s)'

household_theft_offender_table_6b.loc[9, 'table_title'] = 'Age of offender(s)'

household_theft_offender_table_6b.loc[16, 'table_title'] = 'Relationship to victim'